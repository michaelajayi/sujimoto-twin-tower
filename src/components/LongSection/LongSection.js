...
const LongSection = () => {
  return (
    <section className='long-section relative flex flex-col w-screen h-auto mx-auto justify-center items-center py-28'>
      <img src={sttBigText} alt='stt-big-text' className='w-1/2 md:w-1/3' />

      {/* Four Bar Lines */}
      <img src={fourBarLines} alt='four-bar-lines' className="absolute top-0 left-0 right-0 ml-auto mr-auto four-bar-lines" />
